...
class PayTypeSelector extends React.Component {
  constructor(props) {
    super(props);
    this.onPlayTypeSelected = this.onPlayTypeSelected.bind(this)
    this.state = { selectedPayType: null }
  }
  onPlayTypeSelected(event) {
    ...
    return (
      <div>
        <div className="field">
          ...
          <select onChange={this.onPlayTypeSelected} id="order_pay_type" name="order[pay_type]">
